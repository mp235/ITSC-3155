...
# ------------ END SANDWICHES ENDPOINTS ------------ #



# ------------ BEGIN RESOURCES ENDPOINTS ------------ #
...
# ------------ END RESOURCES ENDPOINTS ------------ #



# ------------ BEGIN RECIPES ENDPOINTS ------------ #
...
# ------------ END RECIPES ENDPOINTS ------------ #



# ------------ BEGIN ORDER DETAIL ENDPOINTS ------------ #
...
@app.get("/order_details/{order_detail_id}", response_model=schemas.Recipe, tags=["Order_Details"])
